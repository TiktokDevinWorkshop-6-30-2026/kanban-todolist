...
function createDemoTasks() {
    return [
        ...
        { id:'demo-5', title:'Export and import tasks as JSON', desc:'Backup/restore so data is not trapped here.',  priority:'low',    column:'done',     createdAt:Date.now()-25*3600*1000, editedAt:Date.now()-24*3600*1000, completed:true, completedAt:Date.now()-24*3600*1000 }
    ];
}
